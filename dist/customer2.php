...
<section>
    <form style="width: 90%;margin-left:70px;padding-top: 40px" id="customerForm">
        ...
        <button type="button" class="btn btn-primary" id="btnRegister" onclick=""><i class="fas fa-check-circle" style="font-size: 25px;padding-right: 10px"></i>Register</button>
    </form>
</section>
    ...
    $('#btnRegister').click(function () {
        ...
        var customerData = $('#customerForm').serialize();
            ...
            $.ajax({
                ...
                method: "POST",
                async: true,
                data: customerData + "&operation=saveCustomer"
            }).done(function (rea) {
                alert(rea);
            })
    });
